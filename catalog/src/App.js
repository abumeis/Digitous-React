              ...
              <Route path="/movie/:id/"
                render={(props) => {
                  return <Movies
                    ...
                    title={this.movies[props.match.params.id].title}
                    director={this.movies[props.match.params.id].director}
                    stars={this.movies[props.match.params.id].stars}
